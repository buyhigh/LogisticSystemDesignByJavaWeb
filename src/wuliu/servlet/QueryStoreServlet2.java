...
public class QueryStoreServlet2 extends HttpServlet {

	
	private static final long serialVersionUID = 7775531810638761018L;
	...
	throws IOException,ServletException{
		...
		//request.getRequestDispatcher("/dd/dd_chaxunkuchun.jsp").forward(request, response);
		System.out.println("进入查询库存");
		request.getRequestDispatcher("/kc/dd_chaxunkuchun.jsp").forward(request, response);
	}
}
