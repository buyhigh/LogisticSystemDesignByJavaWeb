...
public class QueryYlServlet2 extends HttpServlet {

	private static final long serialVersionUID = -3763176755505160031L;
	...
	throws IOException,ServletException{
		...
		System.out.println("QueryYlServlet2");
		...
		request.getRequestDispatcher("/tra/tra_chaxunyunli.jsp").forward(request, response);
