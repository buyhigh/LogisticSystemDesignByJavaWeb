...
public class QueryInStoreServlet extends HttpServlet {

	private static final long serialVersionUID = 798690381063572948L;
	...
	throws IOException,ServletException{
		...
		//request.getRequestDispatcher("/dd/dd_chaxunrukudan.jsp").forward(request,response);
		request.getRequestDispatcher("/kc/dd_chaxunrukudan.jsp").forward(request,response);
	}
