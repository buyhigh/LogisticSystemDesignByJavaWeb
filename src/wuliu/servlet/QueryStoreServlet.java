...
public class QueryStoreServlet extends HttpServlet{

	private static final long serialVersionUID = 6053850378089171314L;
	...
	throws IOException,ServletException{
		...
		for(int j=0;j<listGoodsDto2.size();j++){
            System.out.println("每个实体对象值为"+listGoodsDto2.get(j).getGoodName());
            
        }
		
		System.out.println(listGoodsDto2);
		...
		request.getRequestDispatcher("/jd/jd_chaxunkuchun.jsp").forward(request, response);
	}
