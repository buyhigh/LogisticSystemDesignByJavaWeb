...
public class AddMarketerServlet extends HttpServlet {
	...
	throws ServletException,IOException{
		...
		request.getRequestDispatcher("/gh/gh_zengjiashichangzhuanyuan.jsp").forward(request, response);
	}
	
	protected void doPost(HttpServletRequest request,HttpServletResponse response)
	throws ServletException,IOException{
		String regmarketerId = request.getParameter("regmarketerId");
		String regmarketerpwd = request.getParameter("regmarketerpwd");
		userDao.addUser(regmarketerId,regmarketerpwd,2);
