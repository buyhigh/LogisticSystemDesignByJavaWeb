...
<div class="page-container">
	...
	<ul class="list-group" style="margin-left:400px;width: 400px">
            <li class="list-group-item"><span class="glyphicon glyphicon-user">用户名:</span>     ${profile.userName }</li>
            <li class="list-group-item"><span class="glyphicon glyphicon-user">真名:</span>     ${ profile.realName }</li>
            <li class="list-group-item"><span class="glyphicon glyphicon-heart-empty">电话:</span>     ${ profile.telphone }</li>
            <li class="list-group-item"><span class="glyphicon glyphicon-home">住址:</span>     ${ profile.address }</li>
    </ul>
