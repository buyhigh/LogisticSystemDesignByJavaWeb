...
<!-- Bootstrap Core CSS -->
<link href="bootstrap_template/css/bootstrap.min.css" rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href="bootstrap_template/css/style.css" rel='stylesheet' type='text/css' />
<!-- Graph CSS -->
...
<!-- lined-icons -->
<link rel="stylesheet" href="bootstrap_template/css/icon-font.min.css" type='text/css' />
...
<script src="bootstrap_template/js/jquery-1.10.2.min.js"></script>
   <!--pie-chart--->
<script src="bootstrap_template/js/pie-chart.js" type="text/javascript"></script>
			...
			<!-- top_bg -->
						<div class="top_bg">
								...
								<div class="header_top">
									<div class="top_right">
										<ul>
											<li><a href="contact.html">接单系统</a></li>|
											<li><a href="contact.html">仓管系统</a></li>|
											<li><a href="checkout.html">运输系统</a></li>|
											<li><a href="checkout.html">客户管理系统</a></li>|
											<li><a href="checkout.html">管理员后台</a></li>
										</ul>
									</div>
									<div class="top_left">
										<h2><span></span> 插入一下语句</h2>
									</div>
