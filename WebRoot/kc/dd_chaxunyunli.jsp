	...
	<div class="page-container">
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					...
					<li id="menu-academico"><a href="queryinstore"><i
							class="fa fa-file-text-o"></i> <span>查询入库请求单</span></a></li>
		...
		<form id="form1" name="myForm" action="queryyl" method="post">
			...
			<div class="wl_page">
				...
				<c:if
					test="${requestScope.maxPage > 1 && requestScope.curPage == 1}">
                        	共有<span>${requestScope.count }</span>条，分为<span>${requestScope.maxPage }</span>页，每页<span>10</span>条，当前显示第<span>${requestScope.curPage }</span>页 
                        	[<a disabled="disabled">首页</a>]
                        	[<a disabled="disabled">上一页</a>]
                        	[<a
		...
		<script type="text/javascript">
			...
			$("selP").onchange = function() {
				...
				xhr.open("get", "gettools2?transferPlaceStr=" + transferPlace,
						true);
				xhr.send(null);
			};
			$("selM").onchange = function() {
				...
				xhr.open("get", "gettools?transferModelStr=" + transferModel,
						true);
				xhr.send(null);
			};
