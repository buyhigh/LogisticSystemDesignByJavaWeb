...
<body>
	...
	<form id="form1" name="myForm" action="examinetra" method="post">
		...
		<table class="table table-striped"
			...
			<tbody>
				<c:forEach items="${requestScope.listTransferRequestDto }"
					var="transferRequestDto">
					<tr>
						<td><input type="checkbox" name="chkItem"
							value="${transferRequestDto.transferRequestId }" /></td>
		...
		<div class="wl_page">
			...
			<c:if test="${requestScope.maxPage > 1 && requestScope.curPage == 1}">
                        	...
                        	[<a disabled="disabled">上一页</a>]
                        	[<a
					href="examinetra?pageNum=${requestScope.curPage + 1 }">下一页</a>]
                        	[<a
					href="examinetra?pageNum=${requestScope.maxPage }">末页</a>]
                        	</c:if>
			<c:if
				test="${requestScope.maxPage > 1 && requestScope.curPage > 1 && requestScope.curPage < requestScope.maxPage }">
                        	...
                        	[<a
					href="examinetra?pageNum=${requestScope.curPage - 1 }">上一页</a>]
                        	[<a
					href="examinetra?pageNum=${requestScope.curPage + 1 }">下一页</a>]
                        	[<a
					href="examinetra?pageNum=${requestScope.maxPage }">末页</a>]
