			...
			<div class="inner-content">
				...
				<div class="header_bg">
					...
					<div class="header">
						<div class="head-t">
							<div class="logo">
								<a href="index.html"><img src="../images/logotip.png"
				...
				<div class="wl_page">
					...
					<c:if
						test="${requestScope.maxPageNum > 1 && requestScope.curPage == 1}">
                        		共有<span>${requestScope.count }</span>条，分为<span>${requestScope.maxPageNum }</span>页，每页<span>10</span>条，当前显示第<span>${requestScope.curPage }</span>页 [<a
							disabled="disabled">首页</a>][<a disabled="disabled">上一页</a>][<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=${requestScope.curPage + 1 }">下一页</a>][<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=${requestScope.maxPageNum}">末页</a>]
                        	</c:if>
					<c:if
						test="${requestScope.maxPageNum > 1 && requestScope.curPage > 1 && requestScope.curPage < requestScope.maxPageNum }">
                        		共有<span>${requestScope.count }</span>条，分为<span>${requestScope.maxPageNum }</span>页，每页<span>10</span>条，当前显示第<span>${requestScope.curPage }</span>页 [<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=1">首页</a>][<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=${requestScope.curPage - 1}">上一页</a>][<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=${requestScope.curPage + 1 }">下一页</a>][<a
							href="querystore2?storeId=${requestScope.store.storeId }&pageNum=${requestScope.maxPageNum}">末页</a>]
                        	</c:if>
					<c:if
