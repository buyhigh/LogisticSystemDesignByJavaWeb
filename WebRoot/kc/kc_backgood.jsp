...
.wl_table {
	...
	border-bottom: 3px solid #128be8;
}
...
<body>
	...
	<form id="form1" name="myForm" action="backgoods" method="post" style="margin-left: 330px">
		<div class="wl_hywwt">入库申请单</div>
		<table class="wl_table" cellspacing="0">
			<tr>
				<td> <input type="radio" name="rdque"
