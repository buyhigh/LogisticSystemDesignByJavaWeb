...
<div class="page-container">
	...
	<form id="form1" name="myForm" action="adddispatch" method="post">
                		<div class="wl_content_nav">增加配送通知单</div>
		...
		<table class="wl_table" cellspacing="0">
                            ...
                            <tr>
                            	<td>货物数量</td>
                                <td>
                                	<input type="text" name="goodQuantity" class="wl_inputStyle" value="${requestScope.dispatchDto.goodQuantity }" id="goodQuantityId"/>
                                </td>
                                <td>
                                	<span class="wl_spnTip">*</span>
                                </td>
