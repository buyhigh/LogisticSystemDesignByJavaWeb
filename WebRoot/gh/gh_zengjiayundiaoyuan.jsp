...
<div class="page-container">
	...
	<form class="form-horizontal" role="form" name="myForm" action="addtransporter" method="post" id="form1" style="margin-left: 300px;margin-right: 450px;color:black">
	<div class="form-group">
		<label class="col-sm-2 control-label">运调员名称</label>
		<div class="col-sm-10">
			<input type="text" class="form-control" 
				   placeholder="请输入名字" name="regtransporterId" style="color:black" autocomplete="off">
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-2 control-label">账号密码</label>
		<div class="col-sm-10">
			<input type="password" class="form-control" name="regtransporterpwd"
				   placeholder="请输入密码" autocomplete="off">
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="submit" class="btn btn-default">添加运调员</button>
		</div>
	</div>
</form>
