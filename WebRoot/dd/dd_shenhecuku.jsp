            ...
            <div class="wl_right">
            	<form id="form1" name="myForm" action="examineoss" method="post">
                        ...
                        <div class="wl_page">
                        	...
                        	[<a disabled = "disabled">首页</a>]
                        	[<a disabled = "disabled">上一页</a>]
                        	[<a href="examineoss?pageNum=${requestScope.curPage + 1 }">下一页</a>]
                        	[<a href="examineoss?pageNum=${requestScope.maxPage }">末页</a>]
                        	</c:if>
                        	...
                        	[<a href="examineoss?pageNum=${requestScope.curPage - 1 }">上一页</a>]
                        	[<a href="examineoss?pageNum=${requestScope.curPage + 1 }">下一页</a>]
                        	[<a href="examineoss?pageNum=${requestScope.maxPage }">末页</a>]
                        	</c:if>
